...
update_E_cpp <- function(V_pcs, V_perimeter, V_area, V_npts, E_from, E_to, E_npts, E_area, E_edge_length, E_pcs_merge, E_w, E_perimeter_merge, E_score_size, E_dscore, e_update, V_to_E_from, V_to_E_to, d_mu, d_sig, p_C, p_size, agg_mode, min_npts, max_npts) {
    invisible(.Call('_tessera_update_E_cpp', PACKAGE = 'tessera', V_pcs, V_perimeter, V_area, V_npts, E_from, E_to, E_npts, E_area, E_edge_length, E_pcs_merge, E_w, E_perimeter_merge, E_score_size, E_dscore, e_update, V_to_E_from, V_to_E_to, d_mu, d_sig, p_C, p_size, agg_mode, min_npts, max_npts))
}
...
#'
merge_aggs_cpp <- function(V_pcs, V_area, V_perimeter, V_npts, E_from, E_to, E_npts, E_area, E_edge_length, E_pcs_merge, E_w, E_perimeter_merge, E_score_size, E_dscore, E_dscore_merge, E_iter_merge, d_mu, d_sig, p_C, p_size, iter_max, agg_mode, dscore_thresh, min_npts, max_npts) {
    .Call('_tessera_merge_aggs_cpp', PACKAGE = 'tessera', V_pcs, V_area, V_perimeter, V_npts, E_from, E_to, E_npts, E_area, E_edge_length, E_pcs_merge, E_w, E_perimeter_merge, E_score_size, E_dscore, E_dscore_merge, E_iter_merge, d_mu, d_sig, p_C, p_size, iter_max, agg_mode, dscore_thresh, min_npts, max_npts)
}
